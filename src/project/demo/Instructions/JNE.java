 ...
 * @since OCT 4,2015
 */
public class JNE extends Procedures{
    ...
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode JNE content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words){
        ...
        if (iRX == 0) {
            ...
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]RO->IRR:", insCommonResources.setByteToString(insCommonResources.IRR) +"\n");
