 ...
 * @author 一天
 */
public class VADD extends Procedures{
       ...
       public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode VADD content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            temp = insCommonResources.AdderForFP(insCommonResources.getStorge(insCommonResources, first_addr + i), insCommonResources.getStorge(insCommonResources, second_addr + i), 0);
