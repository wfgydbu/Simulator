 ...
 * 
 */
public class SOB extends Procedures{
    @Override
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode SOB content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words){
        ...
        //->R0-R3
        if (iRX == 0) {
            //insCommonResources.IRR = insCommonResources.R0;
            insCommonResources.setIntegerToByte(insCommonResources.R0, insCommonResources.setByteToInteger(insCommonResources.R0) - 1);
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R0-1->R0:", insCommonResources.setByteToString(insCommonResources.R0) +"\n");
            if (insCommonResources.setByteToInteger(insCommonResources.R0) > 0){
                insCommonResources.PC = insCommonResources.setIntegerToByte(insCommonResources.PC,EA);
                //insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(R0)=0\n");
                ...
                //insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(RO)!=0\n");
            ...
            insCommonResources.setIntegerToByte(insCommonResources.R1, insCommonResources.setByteToInteger(insCommonResources.R1) - 1);
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R1-1->R1:", insCommonResources.setByteToString(insCommonResources.R1) +"\n");
            if (insCommonResources.setByteToInteger(insCommonResources.R1) > 0){
                insCommonResources.PC = insCommonResources.setIntegerToByte(insCommonResources.PC, EA);
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(MAR)->PC:", insCommonResources.setByteToString(insCommonResources.PC) +"\n");
            }
            else{
            ...
            int intRX = insCommonResources.setByteToInteger(insCommonResources.R2);
            intRX = intRX - 1;
            insCommonResources.setIntegerToByte(insCommonResources.R2, intRX);
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R2-1->R2:", insCommonResources.setByteToString(insCommonResources.R2) +"\n");
            if (insCommonResources.setByteToInteger(insCommonResources.R2) > 0){
                insCommonResources.PC = insCommonResources.setIntegerToByte(insCommonResources.PC,EA);
                //insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(R0)=0\n");
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(MAR)->PC:", insCommonResources.setByteToString(insCommonResources.PC) +"\n");
            }
            ...
            insCommonResources.setIntegerToByte(insCommonResources.R3, insCommonResources.setByteToInteger(insCommonResources.R3) - 1);
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R3-1->R3:", insCommonResources.setByteToString(insCommonResources.R3) +"\n");
            if (insCommonResources.setByteToInteger(insCommonResources.R3) > 0){
                insCommonResources.PC = insCommonResources.setIntegerToByte(insCommonResources.PC,EA);
                //insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(R0)=0\n");
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(MAR)->PC:", insCommonResources.setByteToString(insCommonResources.PC) +"\n");
            }
