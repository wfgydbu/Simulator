...
public class RRC extends Procedures{
    ...
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode RRC content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words){
        ...
        switch(iRX){
            case 0:
                ...
                //logical rotate
                insCommonResources.R0 = insLogicOperation.LogicalRotate(fALUInput, iDirection, iCount, insCommonResources);
            ...
            case 1:
                ...
                //logical rotate
                insCommonResources.R1 = insLogicOperation.LogicalRotate(fALUInput, iDirection, iCount, insCommonResources);
            ...
            case 2:
                ...
                //logical rotate
                insCommonResources.R2 = insLogicOperation.LogicalRotate(fALUInput, iDirection, iCount, insCommonResources);
            ...
            case 3:
                ...
                //logical rotate
                insCommonResources.R3 = insLogicOperation.LogicalRotate(fALUInput, iDirection, iCount, insCommonResources);
