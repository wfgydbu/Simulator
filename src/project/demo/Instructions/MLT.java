...
import project.demo.units.Multiplier;
 ...
 * 
 */
public class MLT extends Procedures{
    ...
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode MLT content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words){
        ...
        Multiplier insMultiplier = new Multiplier();
        ...
        if(iRX == 0){
            insMultiplier.calculateMultiplicationByte(fALUInput, sALUInput, insCommonResources.R0, insCommonResources.R1, insCommonResources);
            ...
            insMultiplier.calculateMultiplicationByte(fALUInput, sALUInput, insCommonResources.R2, insCommonResources.R3, insCommonResources);
