 ...
 * 
 */
public class AND extends Procedures{
    @Override
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode AND content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words){
        ...
        if(iRX == 0){
            insCommonResources.R0 = insLogicOperation.returnLogicalANDByte(fALUInput, sALUInput);
            ...
            insCommonResources.R1 = insLogicOperation.returnLogicalANDByte(fALUInput, sALUInput);
            ...
            insCommonResources.R2 = insLogicOperation.returnLogicalANDByte(fALUInput, sALUInput);
            ...
            insCommonResources.R3 = insLogicOperation.returnLogicalANDByte(fALUInput, sALUInput);
