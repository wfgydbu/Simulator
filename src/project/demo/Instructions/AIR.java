...
* 
*/
public class AIR extends Procedures{
    ...
    public boolean EncodeContent(CommonResources insCommonResources, byte[] specificword){
        ...
        System.out.println("Encode AIR content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words) {
        ...
        /*if (iRX == 0) {
            ...
            count = insCommonResources.setByteToInteger(insCommonResources.IRR) + insCommonResources.setByteToInteger(insCommonResources.R1);
            insCommonResources.setIntegerToByte(insCommonResources.R1,insCommonResources.setByteToInteger(insCommonResources.IRR) + insCommonResources.setByteToInteger(insCommonResources.R1));
            ...
            insCommonResources.setIntegerToByte(insCommonResources.R2,insCommonResources.setByteToInteger(insCommonResources.IRR) + insCommonResources.setByteToInteger(insCommonResources.R2));
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]IRR+R2->R2:", insCommonResources.setByteToString(insCommonResources.R2) +"\n");
             ...
             insCommonResources.setIntegerToByte(insCommonResources.R3,insCommonResources.setByteToInteger(insCommonResources.IRR) + insCommonResources.setByteToInteger(insCommonResources.R3));
        ...
        if (iRX == 0) {
            ...
            insCommonResources.R0 = insAdder.returnAdditionByte(sALUInput, iImmed, insCommonResources);
            ...
            insCommonResources.R1 = insAdder.returnAdditionByte(sALUInput, iImmed, insCommonResources);
            ...
            insCommonResources.R2 = insAdder.returnAdditionByte(sALUInput, iImmed, insCommonResources);
            ...
            insCommonResources.R3 = insAdder.returnAdditionByte(sALUInput, iImmed, insCommonResources);
