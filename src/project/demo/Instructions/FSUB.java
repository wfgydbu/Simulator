 ...
 * @author 一天
 */
public class FSUB extends Procedures{
    ...
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode FSUB content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words) {
        ...
        //->FR0,FR1
        if (iFR == 0) {
            insCommonResources.FR0 = insCommonResources.AdderForFP(insCommonResources.FR0,operand,1);
            ...
            insCommonResources.FR1 = insCommonResources.AdderForFP(insCommonResources.FR0,operand,1);
