 ...
 * @author 一天
 */
public class VSUB extends Procedures{
       ...
       public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode VSUB content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words) {
        ...
        if(iI == 1) {
            ...
            EA1 = insCommonResources.setByteToInteger(insCommonResources.getStorge(insCommonResources, EA1));
            EA2 = insCommonResources.setByteToInteger(insCommonResources.getStorge(insCommonResources, EA2));
        ...
        insCommonResources.GUI.AddContectToPane("[GenerateProcedures]", "Encode effective address successfully:EA1:" + EA1 + "EA2:" + EA2 + "\n");
        ...
        first_addr = insCommonResources.setByteToInteger(insCommonResources.getStorge(insCommonResources, EA1));
        second_addr = insCommonResources.setByteToInteger(insCommonResources.getStorge(insCommonResources, EA2));
        
        int length = 0;
           
        //->FR0,FR1
        if (iFR == 0) {
            length = insCommonResources.ConvertFP2INT(insCommonResources.FR0);
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]Length. FR0:", insCommonResources.setByteToString(insCommonResources.FR0) +"\n");
        }
        else if (iFR == 1) {
            length = insCommonResources.ConvertFP2INT(insCommonResources.FR1);
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]Length. FR1:", insCommonResources.setByteToString(insCommonResources.FR1) +"\n");
        }
        else {
             return false;
        }     
        ...
        for (int i = 0; i < length; i++) {
            ...
            temp = insCommonResources.AdderForFP(insCommonResources.getStorge(insCommonResources, first_addr + i), insCommonResources.getStorge(insCommonResources, second_addr + i), 1);
            insCommonResources.setStorge(insCommonResources, temp, first_addr + i);
