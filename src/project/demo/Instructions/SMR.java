...
* 
*/
public class SMR extends Procedures{
    ...
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode SMR content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words) {
        ...
        if(iRX == 0) {
            ...
            //ifALUInput = insCommonResources.setByteToInteger(fALUInput);
            ifALUInput = insCommonResources.returnAppropriateInteger(fALUInput);
            ...
            insCommonResources.R0 = insAdder.returnSubtractionByte(sALUInput, ifALUInput, insCommonResources);
            ...
            insCommonResources.R1 = insAdder.returnSubtractionByte(sALUInput, ifALUInput, insCommonResources);
            ...
            insCommonResources.R2 = insAdder.returnSubtractionByte(sALUInput, ifALUInput, insCommonResources);
            ...
            insCommonResources.R3 = insAdder.returnSubtractionByte(sALUInput, ifALUInput, insCommonResources);
