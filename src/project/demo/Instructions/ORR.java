 ...
 * 
 */
public class ORR extends Procedures{
    ...
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode ORR content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words){
        ...
        if(iRX == 0){
            insCommonResources.R0 = insLogicOperation.returnLogicalORByte(fALUInput, sALUInput);
            ...
            insCommonResources.R1 = insLogicOperation.returnLogicalORByte(fALUInput, sALUInput);
            ...
            insCommonResources.R2 = insLogicOperation.returnLogicalORByte(fALUInput, sALUInput);
            ...
            insCommonResources.R3 = insLogicOperation.returnLogicalORByte(fALUInput, sALUInput);
