 ...
 * 
 */
public class JZ extends Procedures{
    @Override
    public boolean EncodeContent(CommonResources insCommonResources,byte[] specificword){
        ...
        System.out.println("Encode JZ content: " +  res);
    ...
    public boolean GenerateProcedures(CommonResources insCommonResources, byte[] words){
        ...
        if(iIX == 0){
            ...
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]IAR+X1->IAR:", insCommonResources.setByteToString(insCommonResources.IAR) +"\n");
        }
        else if(iIX == 2){
        ...
        if (iRX == 0) {
            ...
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R0->IRR:", insCommonResources.setByteToString(insCommonResources.IRR) +"\n");
            ...
            insCommonResources.IRR = insCommonResources.R1;
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R1->IRR:", insCommonResources.setByteToString(insCommonResources.IRR) +"\n");
            if (insCommonResources.setByteToInteger(insCommonResources.R1) == 0){
                insCommonResources.PC = insCommonResources.GetPartofBytes(insCommonResources.MAR, 4, 15);
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(R1)=0\n");
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter + "]c(MAR)->PC:", insCommonResources.setByteToString(insCommonResources.PC) +"\n");
            }
            else{
                pos = pos - 1;
            ...
            insCommonResources.IRR = insCommonResources.R2;
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R2->IRR:", insCommonResources.setByteToString(insCommonResources.IRR) +"\n");
            if (insCommonResources.setByteToInteger(insCommonResources.R2) == 0){
                insCommonResources.PC = insCommonResources.GetPartofBytes(insCommonResources.MAR, 4, 15);
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(R2)=0\n");
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter + "]c(MAR)->PC:", insCommonResources.setByteToString(insCommonResources.PC) +"\n");
            }
            else{
                pos = pos - 1;
            ...
            insCommonResources.IRR = insCommonResources.R3;
            insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]R3->IRR:", insCommonResources.setByteToString(insCommonResources.IRR) +"\n");
            if (insCommonResources.setByteToInteger(insCommonResources.R3) == 0){
                insCommonResources.PC = insCommonResources.GetPartofBytes(insCommonResources.MAR, 4, 15);
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter++ + "]c(R3)=0\n");
                insCommonResources.GUI.AddContectToPane("[CLOCK" + insCommonResources.ClockConter + "]c(MAR)->PC:", insCommonResources.setByteToString(insCommonResources.PC) +"\n");
            }
            else{
                pos = pos - 1;
